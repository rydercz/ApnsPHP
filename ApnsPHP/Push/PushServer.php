...
/**
 * @file
 * ApnsPHP\Push\ApnsPHP_Push_Server class definition.
 *
 * LICENSE
 *
...
use ApnsPHP\Message;
use ApnsPHP\Push;
use ApnsPHP\Push\Server\ServerPushException;

/**
 * @defgroup ApnsPHP\Push\ApnsPHP_Push_Server Server
 ...
 *
 * @ingroup ApnsPHP\Push\ApnsPHP_Push_Server
 */
class PushServer extends Push
{
    ...
    /**< @type integer Message queue start identifier for messages. For every process 1 is added to this number. */
     ...
     * @throws ServerPushException if is unable to
